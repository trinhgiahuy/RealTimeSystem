...
# define IRQGEN_CTRL_REG_F_ACK        GENMASK( 5, 2) // FIXME: check in the reference documentation

# define IRQGEN_GENIRQ_REG_F_LINE     GENMASK( 3, 0) // FIXME: check in the reference documentation
# define IRQGEN_GENIRQ_REG_F_DELAY    GENMASK( 19, 6) // FIXME: check in the reference documentation
# define IRQGEN_GENIRQ_REG_F_AMOUNT   GENMASK( 31, 20) // FIXME: check in the reference documentation
